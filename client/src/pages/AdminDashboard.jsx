...
import profilePic from '../assets/piccolo-pic.webp';  // Default profile picture in case the avatar is missing
            ...
            <div className="admin-dashboard-content">
                <div className="admin-welcome-box">
                    ...
                    <div className="name-message">
                        <h1>{currentTime}{userInfo ? userInfo.firstName : 'Admin'}</h1>
                        <h4>{timeMessage}</h4>
                    </div>
